...
import { useCollapse } from 'react-collapsed'; // Import useCollapse as a named export
import './Colour.css'; // Import CSS

import Chkinput from '../Input/Chkinput'; // Import custom component

const Colour = ({ handleChange }) => { // Define Colour component

  // Destructure properties from useCollapse hook
...
export default Colour; // Export Colour component
