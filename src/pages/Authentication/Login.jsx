...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center px-16 py-20 bg-white max-md:px-5">
      <div className="flex flex-col px-16 py-14 mt-28 max-w-full bg-white shadow-sm w-[538px] max-md:px-5 max-md:mt-10 border rounded-sm">
        <div className="self-center text-6xl font-semibold leading-10 text-black m-8">
          Login
        </div>
        ...
        <button
          type="button"
          className="px-4 py-4  text-3xl font-semibold leading-6 text-white rounded-lg mt-7 bg-rose-600 max-md:px-5">
          Send One Time Password
        </button>

        <div className="flex gap-2 justify-center items-center mt-3.5  text-3xl">
        ...
        <div className="flex justify-center items-center px-16 py-2.5 mt-4 w-full text-2xl font-semibold leading-6 text-black bg-white rounded-lg border border-black border-solid max-md:px-5">
        ...
        <div className="mt-20 text-3xl leading-6 max-md:mt-10">
          ...
          <a href="/Signup" className="font-medium text-red-600"> Create an account</a>
